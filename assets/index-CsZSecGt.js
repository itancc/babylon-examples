import{j as m}from"./index-BPyunkCa.js";import{B as u,E as s,b as x,T as p}from"./index-BwvpWiVZ.js";import{M as d}from"./meshBuilder-DHje3-WW.js";import"./useOneFrame-BIO5UVYM.js";const f=`precision highp float;\r
...
}`,g="/babylon-examples/assets/R-Coye8kRe.jpg",j=()=>{const v=c=>{const{scene:o}=c,r=d.CreateGround("box",{width:5,height:5,subdivisions:100,updatable:!0},o);s.ShadersStore.boxVertexShader=f,s.ShadersStore.boxFragmentShader=b;const t=new x("boxShader",o,{vertex:"box",fragment:"box"},{attributes:["position","uv"],uniforms:["view","projection","time","world","worldViewProjection"],samplers:["textureSampler"]}),l=new p(g,o);t.setTexture("textureSampler",l),t.wireframe=!1,r.material=t;let n=0;r.material.onBindObservable.add(()=>{var e,a,i;n+=.01,(i=(a=(e=r==null?void 0:r.material)==null?void 0:e.getEffect)==null?void 0:a.call(e))==null||i.setFloat("time",n)})};return m.jsx(u,{onMount:v})};export{j as default};
